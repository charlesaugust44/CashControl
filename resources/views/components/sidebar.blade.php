<div>
    <aside class="app-sidebar" id="appSidebar">
        <div class="sidebar-brand">
            ...
            <span class="sidebar-brand__text">{{ config('app.name', 'Cash Control') }}</span>
